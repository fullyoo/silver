...
$(function () {
    ...
    // ===== 11. 레이어팝업 공통 함수(로그인팝업, 자원봉사신청 팝업) =====

    // 팝업 열기
    // function openPopup(popupSelector) {
    //     $(popupSelector).fadeIn(200).addClass("active");
    //     $("body").css("overflow", "hidden");

    //     // 팝업 내부 클릭 시 버블링 방지
    //     $(popupSelector).find(".popup, .login-popup").click(function (e) {
    //         e.stopPropagation();
    //     });
    ...
    //     $(popupSelector).fadeOut(200).removeClass("active");
    //     $("body").css("overflow", "auto");
    // }

    // // ===== 자원봉사 팝업 =====
    // $(".check-list .more").click(function (e) {
    //     e.preventDefault();
    //     openPopup(".popup-wrap");
    // });

    // // 자원봉사 팝업 닫기 버튼
    // $(".popup-wrap .popup-close").click(function () {
    //     closePopup(".popup-wrap");
    // });

    // // ===== 로그인 팝업 =====
    // $(".login-btn").click(function (e) {
    //     e.preventDefault();
    //     openPopup(".login-popup-overlay");
    // });

    // // 로그인 팝업 닫기 버튼
    // $(".login-popup-close").click(function () {
    //     closePopup(".login-popup-overlay");
    // });
